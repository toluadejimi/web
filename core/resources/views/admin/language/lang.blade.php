                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button--group">
                                            ...
                                            @permit('admin.language.manage.update')
                                            ...
                                            @if($item->id != 1)
                                                @permit('admin.language.manage.delete')
...
@push('breadcrumb-plugins')
    @permit('admin.language.manage.store')
