                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button--group">
                                            @permit('admin.extensions.update')
                                            ...
                                            @else 
                                                <button type="button" class="btn btn-sm btn-outline--primary ms-1 mb-2" disabled>
                                                    <i class="la la-cogs"></i> @lang('Configure')
                                                </button>
                                            @endpermit
                                            ...
                                            @permit('admin.extensions.status')
                                            ...
                                            @else 
                                                @if($extension->status == 0)
                                                    <button type="button" class="btn btn-sm btn-outline--success ms-1 mb-2" disabled>
                                                        <i class="la la-eye"></i> @lang('Enable')
                                                    </button>
                                                @else
                                                    <button type="button" class="btn btn-sm btn-outline--danger mb-2" disabled>
                                                        <i class="la la-eye-slash"></i> @lang('Disable')
                                                    </button>
                                                @endif
                                            @endpermit
