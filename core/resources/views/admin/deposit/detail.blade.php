                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Username')
                            <span class="fw-bold"> 
                                <a href="{{ permit('admin.users.detail') ? route('admin.users.detail', $deposit->user_id) : 'javascript:void(0)' }}">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    ...
                                    @elseif($val->type == 'file')
                                        @permit('admin.download.attachment') 
                                            @if($val->value)
