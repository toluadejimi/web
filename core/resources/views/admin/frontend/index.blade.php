                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.frontend.sections.content', $key)}}" method="POST" enctype="multipart/form-data">
                            ...
                            @permit('admin.frontend.sections.content')
                            <div class="form-group">
                                        ...
                                        <td>
                                            <div class="button--group">
                                                ...
                                                @permit('admin.frontend.sections.content')
                                                    ...
                                                    @endpermit
                                                @else
                                                    @permit('admin.frontend.sections.element')
                                                    ...
                                                    @else 
                                                        <a href="javascript:void(0)" class="btn btn-sm btn-outline--primary"><i class="la la-pencil-alt"></i> @lang('Edit')</a>
                                                    @endpermit
                                                @endif
                                                @permit('admin.frontend.remove')
                                                ...
                                                @else 
                                                    <button class="btn btn-sm btn-outline--danger" disabled><i class="la la-trash"></i> @lang('Remove')</button>
                                                @endpermit
                                            </div>
                                        </td>
                                    </tr>
