                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu p-0">
                                                ...
                                                @permit('admin.cron.schedule.pause')
                                                    @if($cron->is_running)
                                                ...
                                                @else 
                                                    @if($cron->is_running)
                                                        <a href="javascript:void(0)" class="dropdown-item"><i class="las la-pause"></i> @lang('Pause')</a>
                                                    @else
                                                        <a href="javascript:void(0)" class="dropdown-item"><i class="las la-play"></i> @lang('Play')</a>
                                                    @endif
                                                @endpermit

                                                @permit('admin.cron.update')
