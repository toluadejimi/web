                            ...
                            <div class="row gy-4">
                                <div class="col-sm-12"> 
                                    <div class="form-group">
                                        <label>@lang('Select Gateway') <span class="text--danger">*</span></label>
                                        <select class="form-control form--control form-select h-45" name="gateway" required>
                                ...
                                <div class="col-sm-12"> 
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" step="any" name="amount" class="form-control form--control h-45"
